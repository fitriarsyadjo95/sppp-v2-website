...
export default function LembagaPengarahTelukEwaPage() {
  return (
    <PageTemplate
      ...
      breadcrumbs={[{ name: 'Utama', href: '/' }, { name: 'Profil', href: '/profil' }, { name: 'Organisasi', href: '/profil/organisasi' }, { name: 'Lembaga Pengarah', href: '/profil/organisasi/lembaga-pengarah' }, { name: 'Teluk Ewa' }]}
    >
      <div className="prose prose-lg max-w-none">
        <div className="bg-sppp-light-gray rounded-lg p-8 mb-8">
          ...
          <p className="text-sppp-gray">
            Ahli-ahli Lembaga Pengarah Teluk Ewa
          </p>
        </div>
